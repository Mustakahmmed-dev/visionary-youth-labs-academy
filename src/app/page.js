...
export default function Home() {
  return (
    <div className="max-w-screen mx-auto flex flex-col justify-center items-center min-h-screen p-6">
      <h1 className="text-4xl font-bold">Visionary Youth Labs Academy</h1>
      <p className="text-lg my-5 text-gray-800">
